...
def compliments_results():
    ...
    context = {
       ...
       'compliment_option': request.args.get('wants_compliments'),
...
def animal_facts():
    ...
    if request.args.get('animal') != None:
        selected_animal_fact = animal_to_fact[request.args.get('animal')]
        context['selected_animal_fact'] = selected_animal_fact
